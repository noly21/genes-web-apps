    ...
    <fieldset>
        ...
        <?php
           ...
           echo $this->Form->hidden('post_type',array('value' => 'module'));
            echo $this->Form->control('course_id', ['options' => $courses, 'value' => $courseID, ($courseID) ? 'disabled' : '']);
            echo ($courseID) ? $this->Form->hidden('course_id', ['value' => $courseID]) : '';
            echo $this->Form->control('resources_id', ['options' => $resources, 'value' => $courseID]);
